...
async function CardAccess(idx, printedNumber, token)
{
    ...
    //const token = await getAuthCookie(cred_username, cred_secure_password);
    console.log('🔍 Sending card access request: ');
...
//TODO: Needs to be reworked still for selecting from UI, but lacks API like calls it seems
